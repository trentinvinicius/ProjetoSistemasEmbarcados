...
/** 
* Funcao que atualiza a luminosidade do LED.
* Isso ocorre alterando o duty-cicle do PWM, cujo valor maximo e 4096 que equivale ao LED totalmente apagado.
* Feito isso, altera a variavel referente ao estado da maquina de estados
*/
void SetPWM()
{
...
/** 
* Funcao que armazena o novo percentual de luminosidade do LED e a duracao em minutos do percentual anterior
* Caso o indice for 11 os dados dos vetores PWM e TEMPO sao combinados e gravados na memoria EEPROM
* A penultima posicao do vetor PWM e realocada para a primeira posicao do vetor, pois ainda nao ha informacao de tempo disponivel
* referente ao valor de PWM setado
* Feito isso, altera a variavel referente ao estado da maquina de estados
*/
void Gravar()
{	
...
/**
* \fn initSM()
* Funcao que inicializa as variaveis da maquina de estados e
* referencia cada estado a sua funcao especifica
*/
void initSM()
{
	sm.state = STLerSensor;
